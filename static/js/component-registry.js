...
<body>
  ...
  '_index': (props) => `<template x-for="component in props.content.components"></template>`,
  '../content/_index.html': (props) => `<template x-for="component in props.content.components"></template>`,
...
<div style="padding: 2rem; max-width: 800px; margin: 0 auto;">
  ...
  'pages': (props) => `<div class="page-content-container"><template x-for="component in props.content.components"></template>
</div><style>
...
<body>
  ...
  '../content/pages.html': (props) => `<div class="page-content-container"><template x-for="component in props.content.components"></template>
</div><style>
  /* Container for page content - centers and constrains text-heavy pages */
  .page-content-container {
    max-width: 80rem;
...
@media only screen and (min-width: 64rem) {
  ...
  '../components/jim_test_greeting.html': (props) => `<div class="text-content-container">
  <div style="background-color: #f0f0f0; padding: 0.5rem 1rem; border-radius: 0.25rem; margin-bottom: 1rem; font-size: 0.875rem; color: #666;">
    ⚡ Build time: <strong>${props.buildTime}</strong>
  </div>
