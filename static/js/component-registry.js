...
<div class="container">
  ...
  '../components/jim_test_todos.html': (props) => `<div style="margin: 2rem 0;">
...
<body :style="$store.theme.bodyStyle">
  ...
  '../content/jim-test.html': (props) => `<!-- Pages Layout - Renders dynamic components from content JSON --><!-- NOTE: <head> provided by wrapper layout (includes Alpine.js + runtime-components.js) --><!-- NOTE: No fence section - uses variables from parent scope (html.html wrapper) --><template x-for="component in props.content.components"></template>`,
...
.toggle-btn:hover {
  ...
  '../components/jim_test_advanced_loops.html': (props) => `<div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 0.5rem; padding: 1.5rem; margin: 2rem 0;">
...
.cart-total {
  ...
  '../components/jim_test_greeting.html': (props) => `<div style="background-color: #f0f0f0; padding: 0.5rem 1rem; border-radius: 0.25rem; margin-bottom: 1rem; font-size: 0.875rem; color: #666;">
  ⚡ Build time: <strong>${props.buildTime}</strong>
</div><h1>${props.salutation} ${props.name}!</h1><!-- Basic conditionals --><template x-if="name.length > 3">
  ...
  <div id="praise">${props.name} is a short name</div></template><style>
  h1 {
    color: orange;
  }
  #praise {
...
<body :style="$store.theme.bodyStyle">
  ...
  '../components/jim_test_animals_loop.html': (props) => `<div class="animals" style="background-color: #f0f0f0; padding: 1rem; margin: 2rem 0;">
  ...
  'jim_test_greeting': (props) => `<div style="background-color: #f0f0f0; padding: 0.5rem 1rem; border-radius: 0.25rem; margin-bottom: 1rem; font-size: 0.875rem; color: #666;">
  ⚡ Build time: <strong>${props.buildTime}</strong>
</div><h1>${props.salutation} ${props.name}!</h1><!-- Basic conditionals --><template x-if="name.length > 3">
  <div id="praise">${props.name} is a long name</div><template x-if="age > 1">
    <div>Has been born</div></template></template><template x-else-if="name.length == 2">
...
.draft-message p {
  ...
  '../components/jim_test_user_profiles.html': (props) => `<div style="margin: 2rem 0;">
  <h2>User Profile Examples with Object Props</h2>
</div><style>
  h2 {
    color: #1f2937;
...
<body>
  ...
  '../components/jim_test_notifications.html': (props) => `<div style="margin: 2rem 0;">
  <h2>Interactive Notification Examples</h2>
  <div style="display: flex; gap: 0.5rem; margin-bottom: 1rem; flex-wrap: wrap;"><template x-for="notif in props.notifications">
      <button style="padding: 0.5rem 1rem; border-radius: 0.375rem; border: none; cursor: pointer; background-color: #3b82f6; color: white;" :onclick="currentNotification = notif">
        Show <span x-text="notif.type"></span>
...
@media only screen and (min-width: 64rem) {
  ...
  '../components/jim_test_age_examples.html': (props) => `<div style="margin: 2rem 0;">
  <h2>Age Component Examples</h2>
  <div style="margin-bottom: 0.5rem; font-size: 0.875rem; color: #666;">Passing dynamic props to components:</div>
</div><style>
  h2 {
...
.draft-message p {
  ...
  'jim-test': (props) => `<!-- Pages Layout - Renders dynamic components from content JSON --><!-- NOTE: <head> provided by wrapper layout (includes Alpine.js + runtime-components.js) --><!-- NOTE: No fence section - uses variables from parent scope (html.html wrapper) --><template x-for="component in props.content.components"></template>`,
