...
<body>
  ...
  'layouts_content_comprehensive_html': (props) => `<html lang="en">
<head>
  <meta charset="UTF-8"></meta>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"></meta>
...
@media only screen and (min-width: 64em) {
  ...
  'layouts_content_script-test_html': (props) => `<html lang="en">
<head>
  <meta charset="UTF-8"></meta>
...
<body>
  ...
  'layouts_content_store-test_html': (props) => `<html lang="en">
<head>
  <meta charset="UTF-8"></meta>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"></meta>
  <title>${props.title}</title>
...
@media only screen and (min-width: 81.25rem) {
  ...
  'layouts_content_dashboard_html': (props) => `<html lang="en">
<head>
  <meta charset="UTF-8"></meta>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"></meta>
  <title>${props.pageTitle} - Custom Go Template</title>
            ...
            <nav class="cs-nav" aria-label="main navigation">
                ...
                <div class="cs-ul-wrapper" id="cs-ul-wrapper">
                    <ul class="cs-ul">
                        ...
                        <li class="cs-li">
                            <a href="/jim-test" class="cs-li-link">
                                About
                            </a>
                        </li>
                        <!-- News Dropdown -->
                        <li class="cs-li cs-dropdown">
                            <button class="cs-li-link cs-dropdown-toggle" aria-expanded="false" aria-haspopup="menu" id="news-dropdown-toggle">
                                News
                            ...
                            <ul class="cs-drop-ul" aria-labelledby="news-dropdown-toggle">
                                <li class="cs-drop-li">
                                    <a href="/news_page" class="cs-li-link cs-drop-link">All News</a>
                                </li>
                                <li class="cs-drop-li">
                                    <a href="/news/new-product-launch" class="cs-li-link cs-drop-link">Product Launch</a>
                                </li>
                                <li class="cs-drop-li">
                                    <a href="/news/quarterly-results" class="cs-li-link cs-drop-link">Quarterly Results</a>
                                </li>
                                <li class="cs-drop-li">
                                    <a href="/news/team-expansion" class="cs-li-link cs-drop-link">Team Expansion</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    <ul class="cs-ul">
                        <!-- Committee Dropdown -->
                        <li class="cs-li cs-dropdown">
                            <button class="cs-li-link cs-dropdown-toggle" aria-expanded="false" aria-haspopup="menu" id="committee-dropdown-toggle">
                                Committee
                                <img class="cs-drop-icon" src="https://csimages2.nyc3.digitaloceanspaces.com/Icons/chevron-dropdown.svg" alt="" width="15" height="15" decoding="async" aria-hidden="true"></img>
                            </button>
                            <ul class="cs-drop-ul" aria-labelledby="committee-dropdown-toggle">
                                <li class="cs-drop-li">
                                    <a href="/committee_page" class="cs-li-link cs-drop-link">All Meetings</a>
                                </li>
                                <li class="cs-drop-li">
                                    <a href="/committee/post1" class="cs-li-link cs-drop-link">October 2025</a>
                                </li>
                                <li class="cs-drop-li">
                                    <a href="/committee/post2" class="cs-li-link cs-drop-link">September 2025</a>
                                </li>
                                <li class="cs-drop-li">
                                    <a href="/committee/post3" class="cs-li-link cs-drop-link">July 2025</a>
                                </li>
                            </ul>
                        </li>
                        <li class="cs-li">
                            <a href="/store-demo" class="cs-li-link">Store</a>
                        </li>
                    </ul>
                </div>
...
.toggle-btn:hover {
  ...
  'layouts_content_simple_html': (props) => `<html lang="en">
<head>
  <meta charset="UTF-8"></meta>
...
:style="&#96;background: &#36;&#123;&#36;store.theme.getCurrentColors().background&#125;;
  ...
  * {
  ...
  'simple': (props) => registry['layouts_content_simple_html'](props),
  ...
  'script-test': (props) => registry['layouts_content_script-test_html'](props),
  '_index': (props) => registry['layouts_content__index_html'](props),
  'dashboard': (props) => registry['layouts_content_dashboard_html'](props),
  ...
  'comprehensive': (props) => registry['layouts_content_comprehensive_html'](props),
